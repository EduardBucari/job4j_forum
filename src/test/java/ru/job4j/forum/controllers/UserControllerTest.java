...
public class UserControllerTest {
    ...
    public void shouldUserServiceSaveCall() throws Exception {
        ...
        assertThat(argument.getValue().getName(), is("Иванов Иван Иванович"));
        assertThat(argument.getValue().getLogin(), is("Ivan"));
        assertThat(argument.getValue().getEmail(), is("ivanov@mail.ru"));
    }
}